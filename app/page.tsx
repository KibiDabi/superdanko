...
// Import components normally but wrap them in LazyWrapper for performance
  ...
  return (
    <div className="mx-auto relative space-y-12 lg:space-y-0 flex min-h-screen flex-col ">
      ...
      <div className=" mb-20 px-4 space-y-5 py-9 dark:bg-transparent md:py-11 lg:py-22">
        <AnimatedTextSection />
        <div className=" grid mx-auto w-full md:max-w-5xl gap-4 sm:grid-cols-2 md:grid-cols-3">
          <ProductList />
        </div>
      </div>
